...
return [
    ...
    'methods', {
        ...
        _syncChildren: function(targetList, onVictim) {
            // TODO: this algorithm is not good. for example, removing
            // item from start of list results in a whole bunch of
            // reordering rather than simply removing the first one
